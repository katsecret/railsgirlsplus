...
class SuppliersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create supplier" do
    assert_difference('Supplier.count') do
      post suppliers_url, params: { supplier: { city: @supplier.city, name: @supplier.name, street: @supplier.street } }
    end
  ...
  test "should update supplier" do
    patch supplier_url(@supplier), params: { supplier: { city: @supplier.city, name: @supplier.name, street: @supplier.street } }
